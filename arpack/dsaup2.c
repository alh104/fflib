/* src/dsaup2.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void dsaup2_(integer *ido, char *bmat, integer *n, char *
	...
	doublereal *workl, integer *ipntr, doublereal *workd, integer *info)
{
    ...
    extern /* Subroutine */ void dsaitr_(integer *, char *, integer *, integer 
...
/*           %----------------------------------------------------% */
	...
	s_copy(wprime, "la", (ftnlen)2, (ftnlen)2);
	dsortr_(wprime, &c_true, &nev0, &bounds[1], &ritz[1]);
