/* src/dnaupd.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void dnaupd_(integer *ido, char *bmat, integer *n, char *
	...
	doublereal *workd, doublereal *workl, integer *lworkl, integer *info)
{
    ...
    extern /* Subroutine */ void secnd2_(real *), dnaup2_(integer *, char *, 
	    integer *, char *, integer *, integer *, doublereal *, doublereal 
    ...
    extern /* Subroutine */ void dstatn_(void);
