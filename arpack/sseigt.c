/* src/sseigt.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void sseigt_(real *rnorm, integer *n, real *h__, integer *ldh,
	 real *eig, real *bounds, real *workl, integer *ierr)
{
    ...
    extern /* Subroutine */ void scopy_(integer *, real *, integer *, real *, 
	    integer *), secnd2_(real *), svout_(integer *, integer *, real *, 
	    integer *, char *, ftnlen);
    static integer msglvl;
    extern /* Subroutine */ void sstqrb_(integer *, real *, real *, real *, 
	    real *, integer *);
