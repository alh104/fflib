/* src/cnaupd.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void cnaupd_(integer *ido, char *bmat, integer *n, char *
	...
	complex *workl, integer *lworkl, real *rwork, integer *info)
{
    ...
    extern /* Subroutine */ void cvout_(integer *, integer *, complex *, 
	    ...
	    , integer *, char *, ftnlen), secnd2_(real *), cnaup2_(integer *, 
	    char *, integer *, char *, integer *, integer *, real *, complex *
    ...
    extern /* Subroutine */ void cstatn_(void);
