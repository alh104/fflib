/* src/zngets.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void zngets_(integer *ishift, char *which, integer *kev, 
	integer *np, doublecomplex *ritz, doublecomplex *bounds)
{
    ...
    extern /* Subroutine */ void zsortc_(char *, logical *, integer *, 
