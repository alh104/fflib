/* src/ssgets.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void ssgets_(integer *ishift, char *which, integer *kev, 
	integer *np, real *ritz, real *bounds, real *shifts)
{
    ...
    extern /* Subroutine */ void ssortr_(char *, logical *, integer *, real *, 
	    real *);
