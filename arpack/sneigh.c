/* src/sneigh.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void sneigh_(real *rnorm, integer *n, real *h__, integer *ldh,
	...
	workl, integer *ierr)
{
    ...
    extern /* Subroutine */ void sscal_(integer *, real *, real *, integer *), 
	    ...
	    char *, ftnlen), secnd2_(real *), svout_(integer *, integer *, 
	    real *, integer *, char *, ftnlen);
    extern doublereal slapy2_(real *, real *);
    static logical select[1];
    static integer msglvl;
    extern /* Subroutine */ void slacpy_(char *, integer *, integer *, real *, 
	    integer *, real *, integer *), slaqrb_(logical *, integer 
