/* src/cneigh.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void cneigh_(real *rnorm, integer *n, complex *h__, integer *
	...
	complex *workl, real *rwork, integer *ierr)
{
    ...
    extern /* Subroutine */ void ccopy_(integer *, complex *, integer *, 
	    ...
	    , integer *, complex *, integer *, char *, ftnlen), secnd2_(real *
	    );
    ...
    extern /* Subroutine */ void ctrevc_(char *, char *, logical *, integer *, 
	    complex *, integer *, complex *, integer *, complex *, integer *, 
	    integer *, integer *, complex *, real *, integer *), claset_(char *, integer *, integer *, complex *, complex 
	    *, complex *, integer *);
