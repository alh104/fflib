/* src/dneupd.f -- translated by f2c (version 20100827).
...
/* ----------------------------------------------------------------------- */
/* Subroutine */ void dneupd_(logical *rvec, char *howmny, logical *select, 
	...
	integer *lworkl, integer *info)
{
    ...
    extern /* Subroutine */ void dlacpy_(char *, integer *, integer *, 
	    ...
	    doublereal *, integer *, doublereal *, integer *, doublereal *, 
	    integer *, integer *, integer *, doublereal *, integer *), dtrsen_(char *, char *, logical *, integer *, doublereal 
	    *, integer *, doublereal *, integer *, doublereal *, doublereal *,
