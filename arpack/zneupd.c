/* src/zneupd.f -- translated by f2c (version 20100827).
...
/* ----------------------------------------------------------------------- */
/* Subroutine */ void zneupd_(logical *rvec, char *howmny, logical *select, 
	...
	doublereal *rwork, integer *info)
{
    ...
    extern /* Subroutine */ void zgeru_(integer *, integer *, doublecomplex *, 
	    ...
	    *, integer *, integer *, char *, ftnlen), ztrmm_(char *, char *, 
	    ...
	    doublecomplex *, integer *, doublecomplex *, integer *), zmout_(integer *, integer *, integer *, 
    ...
    extern /* Subroutine */ void zlacpy_(char *, integer *, integer *, 
	    ...
	    doublecomplex *, integer *, doublecomplex *, integer *, 
	    doublereal *, doublereal *, doublecomplex *, integer *, integer *), ztrevc_(char *, char *, logical *, integer *, 
	    doublecomplex *, integer *, doublecomplex *, integer *, 
