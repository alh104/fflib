/* src/dngets.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void dngets_(integer *ishift, char *which, integer *kev, 
	 ...
	 doublereal *shiftr, doublereal *shifti)
{
    ...
    extern /* Subroutine */ void dsortc_(char *, logical *, integer *, 
