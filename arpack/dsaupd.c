/* src/dsaupd.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void dsaupd_(integer *ido, char *bmat, integer *n, char *
	...
	doublereal *workd, doublereal *workl, integer *lworkl, integer *info)
{
    ...
    extern /* Subroutine */ void dvout_(integer *, integer *, doublereal *, 
	    ...
	    , integer *, char *, ftnlen), secnd2_(real *), dsaup2_(integer *, 
    ...
    extern /* Subroutine */ void dstats_(void);
