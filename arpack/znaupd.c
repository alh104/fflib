/* src/znaupd.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void znaupd_(integer *ido, char *bmat, integer *n, char *
	...
	doublereal *rwork, integer *info)
{
    ...
    extern /* Subroutine */ void ivout_(integer *, integer *, integer *, 
	    integer *, char *, ftnlen), secnd2_(real *), zvout_(integer *, 
	    integer *, doublecomplex *, integer *, char *, ftnlen), znaup2_(
    ...
    extern /* Subroutine */ void zstatn_(void);
