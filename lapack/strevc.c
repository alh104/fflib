/* fortran/strevc.f -- translated by f2c (version 20100827).
...
/*                    1-by-1 diagonal block */
			...
			slaln2_(&c_false, &c__1, &c__1, &smin, &c_b23, &t[j + 
...
/*                    2-by-2 diagonal block */
			...
			slaln2_(&c_false, &c__2, &c__1, &smin, &c_b23, &t[j - 
...
/* L70: */
		    ...
		    if (ki > 1) {
			i__1 = ki - 1;
			sgemv_("N", n, &i__1, &c_b23, &vr[vr_offset], ldvr, &
...
/*                    1-by-1 diagonal block */
			...
			slaln2_(&c_false, &c__1, &c__2, &smin, &c_b23, &t[j + 
				j * t_dim1], ldt, &c_b23, &c_b23, &work[j + *
...
/*                    2-by-2 diagonal block */
			...
			slaln2_(&c_false, &c__2, &c__2, &smin, &c_b23, &t[j - 
				1 + (j - 1) * t_dim1], ldt, &c_b23, &c_b23, &
...
/*                      [T(J+1,J)    T(J+1,J+1)-WR]             ( WORK2 ) */
			...
			slaln2_(&c_true, &c__2, &c__1, &smin, &c_b23, &t[j + 
				j * t_dim1], ldt, &c_b23, &c_b23, &work[j + *
				n], n, &wr, &c_b26, x, &c__2, &scale, &xnorm, 
				&ierr);
...
/* L180: */
		    ...
		    if (ki < *n) {
			i__2 = *n - ki;
			sgemv_("N", n, &i__2, &c_b23, &vl[(ki + 1) * vl_dim1 
...
/*                      ([T(j+1,j) T(j+1,j+1)]             ) */
			...
			r__1 = -wi;
			slaln2_(&c_true, &c__2, &c__2, &smin, &c_b23, &t[j + 
				j * t_dim1], ldt, &c_b23, &c_b23, &work[j + *
				n], n, &wr, &r__1, x, &c__2, &scale, &xnorm, &
				ierr);
...
/* L230: */
		    ...
		    if (ki < *n - 1) {
			i__2 = *n - ki - 1;
			sgemv_("N", n, &i__2, &c_b23, &vl[(ki + 2) * vl_dim1 
