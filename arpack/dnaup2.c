/* src/dnaup2.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void dnaup2_(integer *ido, char *bmat, integer *n, char *
	 ...
	 integer *info)
{
    ...
    extern /* Subroutine */ void dmout_(integer *, integer *, integer *, 
	    doublereal *, integer *, integer *, char *, ftnlen);
    static logical initv;
    static doublereal rnorm;
    extern /* Subroutine */ void dvout_(integer *, integer *, doublereal *, 
	    integer *, char *, ftnlen), ivout_(integer *, integer *, integer *
	    , integer *, char *, ftnlen), secnd2_(real *), dgetv0_(integer *, 
	    char *, integer *, logical *, integer *, integer *, doublereal *, 
	    integer *, doublereal *, doublereal *, integer *, doublereal *, 
	    integer *);
    extern doublereal dlapy2_(doublereal *, doublereal *), dlamch_(char *);
    extern /* Subroutine */ void dneigh_(doublereal *, integer *, doublereal *,
    ...
    extern /* Subroutine */ void dnaitr_(integer *, char *, integer *, integer 
