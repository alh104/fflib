/* src/sneupd.f -- translated by f2c (version 20100827).
...
/* ----------------------------------------------------------------------- */
/* Subroutine */ void sneupd_(logical *rvec, char *howmny, logical *select, 
	...
	lworkl, integer *info)
{
    ...
    extern /* Subroutine */ void svout_(integer *, integer *, real *, integer *
    ...
    extern /* Subroutine */ void sngets_(integer *, char *, integer *, integer 
