/* fortran/strexc.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void strexc_(char *compq, integer *n, real *t, integer *ldt, 
	...
	integer *info)
{
    ...
    extern /* Subroutine */ void xerbla_(char *, integer *), slaexc_(
