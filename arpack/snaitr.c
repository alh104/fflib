/* src/snaitr.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void snaitr_(integer *ido, char *bmat, integer *n, integer *k,
	...
	info)
{
    ...
    extern /* Subroutine */ void saxpy_(integer *, real *, real *, integer *, 
	    ...
	    , real *, integer *, integer *, char *, ftnlen), secnd2_(real *), 
	    svout_(integer *, integer *, real *, integer *, char *, ftnlen), 
	    sgetv0_(integer *, char *, integer *, logical *, integer *, 
