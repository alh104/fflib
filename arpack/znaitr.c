/* src/znaitr.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void znaitr_(integer *ido, char *bmat, integer *n, integer *k,
	...
	integer *ipntr, doublecomplex *workd, integer *info)
{
    ...
    extern /* Subroutine */ void dvout_(integer *, integer *, doublereal *, 
	    ...
	    *, integer *, integer *, char *, ftnlen), secnd2_(real *), zvout_(
