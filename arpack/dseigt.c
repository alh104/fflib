/* src/dseigt.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void dseigt_(doublereal *rnorm, integer *n, doublereal *h__, 
	...
	integer *ierr)
{
    ...
    extern /* Subroutine */ void dstqrb_(integer *, doublereal *, doublereal *,
