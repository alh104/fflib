/* fortran/zgttrf.f -- translated by f2c (version 20100827).
...
/*           Subdiagonal is zero, no elimination is required. */
	    ...
	    i__2 = i__;
	    if (d__[i__2].r == 0. && d__[i__2].i == 0. && *info == 0) {
		*info = i__;
	    }
	    if (i__ < *n - 1) {
		i__2 = i__;
...
/*           Interchange rows I and I+1, eliminate DL(I) */
		...
		if (i__ < *n - 1) {
		    ...
		    z__1.r = z__2.r * du[i__3].r - z__2.i * du[i__3].i, 
			    z__1.i = z__2.r * du[i__3].i + z__2.i * du[i__3]
			    .r;
...
/* L20: */
    ...
    i__1 = *n;
    if (d__[i__1].r == 0. && d__[i__1].i == 0. && *info == 0) {
	*info = *n;
	return;
    }
