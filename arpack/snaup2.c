/* src/snaup2.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void snaup2_(integer *ido, char *bmat, integer *n, char *
	...
	workd, integer *info)
{
    ...
    extern /* Subroutine */ void scopy_(integer *, real *, integer *, real *, 
	    ...
	    integer *, integer *, char *, ftnlen), secnd2_(real *), svout_(
	    integer *, integer *, real *, integer *, char *, ftnlen), sgetv0_(
    ...
    extern /* Subroutine */ void snaitr_(integer *, char *, integer *, integer 
	    *, integer *, integer *, real *, real *, real *, integer *, real *
	    ...
	    integer *, integer *, real *, real *, real *, real *, real *), snapps_(integer *, integer *, integer *, real *, real *, 
