/* fortran/xerbla.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void xerbla_(char *srname, integer *info)
{
    ...
    /* Builtin functions */
    integer s_wsfe(cilist *), i_len(char *, ftnlen), do_fio(integer *, char *,
	     ftnlen), e_wsfe(void);
...
/*     ALH - 1/4/15 - LEN_TRIM changed to LEN */

    s_wsfe(&io___1);
    do_fio(&c__1, srname, i_len(srname, 6));
