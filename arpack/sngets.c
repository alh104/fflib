/* src/sngets.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void sngets_(integer *ishift, char *which, integer *kev, 
	...
	real *shifti)
{
    ...
    extern /* Subroutine */ void ssortc_(char *, logical *, integer *, real *, 
	    real *, real *);
