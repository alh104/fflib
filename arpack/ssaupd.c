/* src/ssaupd.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void ssaupd_(integer *ido, char *bmat, integer *n, char *
	...
	workl, integer *lworkl, integer *info)
{
    ...
    extern /* Subroutine */ void ivout_(integer *, integer *, integer *, 
	    ...
	    integer *, real *, integer *, char *, ftnlen), ssaup2_(integer *, 
	    char *, integer *, char *, integer *, integer *, real *, real *, 
	    integer *, integer *, integer *, integer *, real *, integer *, 
	    real *, integer *, real *, real *, real *, integer *, real *, 
	    integer *, real *, integer *);
    extern doublereal slamch_(char *);
    static integer bounds, ishift, msglvl, mxiter;
    extern /* Subroutine */ void sstats_(void);
