/* src/cngets.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void cngets_(integer *ishift, char *which, integer *kev, 
	integer *np, complex *ritz, complex *bounds)
{
    ...
    extern /* Subroutine */ void cvout_(integer *, integer *, complex *, 
	    ...
	    , integer *, char *, ftnlen), secnd2_(real *);
    static integer msglvl;
    extern /* Subroutine */ void csortc_(char *, logical *, integer *, complex 
	    *, complex *);
