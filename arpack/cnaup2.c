/* src/cnaup2.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void cnaup2_(integer *ido, char *bmat, integer *n, char *
	...
	complex *workd, real *rwork, integer *info)
{
    ...
    static real rtemp;
    extern /* Subroutine */ void cmout_(integer *, integer *, integer *, 
	    complex *, integer *, integer *, char *, ftnlen);
    static logical initv;
    static real rnorm;
    extern /* Subroutine */ void cvout_(integer *, integer *, complex *, 
	    integer *, char *, ftnlen), ivout_(integer *, integer *, integer *
	    , integer *, char *, ftnlen), secnd2_(real *), svout_(integer *, 
	    integer *, real *, integer *, char *, ftnlen), cgetv0_(integer *, 
	    char *, integer *, logical *, integer *, integer *, complex *, 
	    integer *, complex *, real *, integer *, complex *, integer *);
    extern doublereal scnrm2_(integer *, complex *, integer *), slapy2_(real *
	    , real *);
    extern /* Subroutine */ void cneigh_(real *, integer *, complex *, integer 
    ...
    extern /* Subroutine */ void cnaitr_(integer *, char *, integer *, integer 
