/* fortran/slarfx.f -- translated by f2c (version 20100827).
...
/*        w := C'*v */
	...
	sgemv_("Transpose", m, n, &c_b14, &c__[c_offset], ldc, &v[1], &c__1, &
		c_b16, &work[1], &c__1);
...
/*        w := C * v */
	...
	sgemv_("No transpose", m, n, &c_b14, &c__[c_offset], ldc, &v[1], &
