/* src/ssaup2.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void ssaup2_(integer *ido, char *bmat, integer *n, char *
	...
	info)
{
    ...
    extern /* Subroutine */ void scopy_(integer *, real *, integer *, real *, 
	    ...
	    ftnlen), secnd2_(real *), svout_(integer *, integer *, real *, 
    ...
    extern /* Subroutine */ void ssaitr_(integer *, char *, integer *, integer 
