/* src/zneigh.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void zneigh_(doublereal *rnorm, integer *n, doublecomplex *
	...
	rwork, integer *ierr)
{
    ...
    extern /* Subroutine */ void zcopy_(integer *, doublecomplex *, integer *, 
	    ...
	    *, doublecomplex *, integer *, integer *, char *, ftnlen), 
	    secnd2_(real *), zvout_(integer *, integer *, doublecomplex *, 
	    integer *, char *, ftnlen);
