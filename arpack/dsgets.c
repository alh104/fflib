/* src/dsgets.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void dsgets_(integer *ishift, char *which, integer *kev, 
	integer *np, doublereal *ritz, doublereal *bounds, doublereal *shifts)
{
    ...
    extern /* Subroutine */ void dswap_(integer *, doublereal *, integer *, 
	    ...
	    *, doublereal *, integer *), dvout_(integer *, integer *, 
	    ...
	    integer *, integer *, integer *, char *, ftnlen), secnd2_(real *);
    static integer msglvl;
    extern /* Subroutine */ void dsortr_(char *, logical *, integer *, 
