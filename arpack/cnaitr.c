/* src/cnaitr.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void cnaitr_(integer *ido, char *bmat, integer *n, integer *k,
	...
	workd, integer *info)
{
    ...
    extern doublereal scnrm2_(integer *, complex *, integer *), slapy2_(real *
	    , real *);
    static real rnorm1;
    extern /* Subroutine */ void slabad_(real *, real *), clascl_(char *, 
