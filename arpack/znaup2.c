/* src/znaup2.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void znaup2_(integer *ido, char *bmat, integer *n, char *
	...
	doublereal *rwork, integer *info)
{
    ...
    extern /* Subroutine */ void dvout_(integer *, integer *, doublereal *, 
	    ...
	    *, ftnlen), secnd2_(real *), zvout_(integer *, integer *, 
	    doublecomplex *, integer *, char *, ftnlen);
    extern doublereal dlapy2_(doublereal *, doublereal *), dznrm2_(integer *, 
	    doublecomplex *, integer *);
    extern /* Subroutine */ void zgetv0_(integer *, char *, integer *, logical 
    ...
    extern /* Subroutine */ void znaitr_(integer *, char *, integer *, integer 
