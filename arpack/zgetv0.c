/* src/zgetv0.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void zgetv0_(integer *ido, char *bmat, integer *itry, logical 
	...
	doublecomplex *workd, integer *ierr)
{
    ...
    extern /* Subroutine */ void zgemv_(char *, integer *, integer *, 
	    ...
	    doublecomplex *, integer *), secnd2_(real *), zvout_(integer *, 
