/* src/dneigh.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void dneigh_(doublereal *rnorm, integer *n, doublereal *h__, 
	...
	bounds, doublereal *q, integer *ldq, doublereal *workl, integer *ierr)
{
    ...
    extern /* Subroutine */ void dgemv_(char *, integer *, integer *, 
	    ...
	    char *, ftnlen), secnd2_(real *);
    extern doublereal dlapy2_(doublereal *, doublereal *);
    extern /* Subroutine */ void dlaqrb_(logical *, integer *, integer *, 
