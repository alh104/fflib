/* src/cneupd.f -- translated by f2c (version 20100827).
...
/* ----------------------------------------------------------------------- */
/* Subroutine */ void cneupd_(logical *rvec, char *howmny, logical *select, 
	...
	lworkl, real *rwork, integer *info)
{
    ...
    extern /* Subroutine */ void clahqr_(logical *, logical *, integer *, 
	    ...
	    integer *, real *, real *, complex *, integer *, integer *), ctrevc_(char *, char *, logical *, integer *, 
	    complex *, integer *, complex *, integer *, complex *, integer *, 
	    integer *, integer *, complex *, real *, integer *), csscal_(integer *, real *, complex *, integer *);
