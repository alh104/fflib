/* src/snaupd.f -- translated by f2c (version 20100827).
...
/* Subroutine */ void snaupd_(integer *ido, char *bmat, integer *n, char *
	...
	workl, integer *lworkl, integer *info)
{
    ...
    static integer nb, ih, iq, np, iw, ldh, ldq, nev0, mode, ierr, iupd, next,
	     ritzi;
    extern /* Subroutine */ void ivout_(integer *, integer *, integer *, 
	    integer *, char *, ftnlen);
    static integer ritzr;
    extern /* Subroutine */ void secnd2_(real *), svout_(integer *, integer *, 
	    real *, integer *, char *, ftnlen), snaup2_(integer *, char *, 
	    integer *, char *, integer *, integer *, real *, real *, integer *
	    , integer *, integer *, integer *, real *, integer *, real *, 
	    integer *, real *, real *, real *, real *, integer *, real *, 
	    integer *, real *, integer *);
    extern doublereal slamch_(char *);
    static integer bounds, ishift, msglvl, mxiter;
    extern /* Subroutine */ void sstatn_(void);
